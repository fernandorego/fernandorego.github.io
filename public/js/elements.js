...
export class WhoAmI extends MyElement {
    ...
    setText() {
        ...
        error_text.innerHTML = "<span class='whoami-text'>Fernando Rego is currently enrolled in the Doctoral Program in Informatics and\n"
            ...
            + "assistant lecturer at FEUP and a researcher at Fraunhofer Portugal AICOS, focusing\n"
            + "on embedded systems, distributed systems, and TinyML by integrating Machine Learning\n"
            + "into Internet of Things (IoT) solutions, distributed systems, and embedded systems.</span>\n"
            + "<span class='piano'>"
            + "           ____                       \n"
            + "          | |  \\_______     \n"
            + "          | |          \\  \n"
