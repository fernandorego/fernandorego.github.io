...
export class Projects extends MyElement {
    ...
    setText(): void {
        let projects_text: HTMLParagraphElement = document.createElement('p');
...
export class Email extends MyElement {
    ...
    setText(): void {
        let email_text: HTMLParagraphElement = document.createElement('p');
...
export class Opening extends MyElement {
    ...
    setText(): void {
        let opening_text: HTMLParagraphElement = document.createElement('p');
